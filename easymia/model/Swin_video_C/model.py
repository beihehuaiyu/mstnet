...
from .swin_transformer import CSwinTransformer
...
class Fundus_Backbone(nn.Layer):
    def __init__(self):
        ...
        self.fundus_branch = paddle.vision.models.resnet50(pretrained=True)
...
class Class_Head(nn.Layer):
    def __init__(self, num_classes):
        ...
        self.linear1 = nn.Linear(2024, 512)
...
class Swin_video_C(AbstractModel):
    def __init__(self, mode, num_classes=2):
        super(Swin_video_C, self).__init__(mode)
